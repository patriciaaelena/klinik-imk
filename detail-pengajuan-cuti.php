...
if (!isset($_GET['id']) || empty($_GET['id'])) {
  header("Location: ./riwayat-pengajuan-cuti");
  die;
}
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item">
            <a href="./riwayat-pengajuan-cuti">Riwayat Pengajuan Cuti</a>
          </li>
          ...
          <div class="card-body">
            <div class="row">
              <div class="form-group col-12 col-xl-6 d-flex align-items-center">
                <label for="inputEmail3" class="col-3">Nama</label>
                <div class="input-group col-9">
                  <input class="form-control" type="text" value="<?= $pengajuan['nama_pegawai'] ?>" readonly>
                </div>
              </div>
              <div class="form-group col-12 col-xl-6 d-flex align-items-center">
                <label for="inputEmail3" class="col-3">Jabatan</label>
                <div class="input-group col-9">
                  <input class="form-control" type="text" value="<?= $pengajuan['nama_jabatan'] ?>" readonly>
                </div>
              </div>
              <div class="form-group col-12 col-xl-6 d-flex align-items-center">
                <label for="inputEmail3" class="col-3"><?= empty($pengajuan['nip']) ? "NIK" : "NIP" ?></label>
                <div class="input-group col-9">
                  <input class="form-control" type="text" value="<?= empty($pengajuan['nip']) ? $pengajuan['nik'] : $pengajuan['nip'] ?>" readonly>
                </div>
              </div>
              <div class="form-group col-12 col-xl-6 d-flex align-items-center">
                <label for="inputEmail3" class="col-3">Masa Kerja</label>
                <div class="input-group col-9">
                  <?php
                  ...
                  ?>
                  <input class="form-control" type="text" value="<?= implode(", ", $tgl) ?>" readonly>
                </div>
              </div>
