...
if (!isset($_GET['id']) || empty($_GET['id'])) {
  header("Location: ./detail-pegawai?id=$_GET[pg]");
  die;
}
...
$back = (empty($pengajuan['nip']) ? "NIK." : "NIP.") . " " . (empty($pengajuan['nip']) ? $pengajuan['nik'] : $pengajuan['nip']);
?>
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item">
            <a href="./detail-pegawai?id=<?= $_GET['pg'] ?>"><?= $back ?></a>
          </li>
